...
namespace WorldModelTutorial
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            var iat = IntegratedAuthoringToolAsset.FromJson(File.ReadAllText("C:/Users/JuanJoseAsus/source/repos/FAtiMA-ToolkitLastVersion/Tutorials/Examples/CiF-Tutorial/JobInterview.iat"), new GAIPS.Rage.AssetStorage());
            ...
            while (true)
            {
                ...
                if (action != null)
                {
                    ...
                    Console.WriteLine("Action: " + initiatorName + " does " + action.Name + " to " +
                                     targetName + "/n" + action.Parameters[1]);
        ...
        public static void TEST()
        {
            ...
            iat.AddNewCharacter((Name)"Pedro");
